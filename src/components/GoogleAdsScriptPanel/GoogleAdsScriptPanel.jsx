...
const GOOGLE_ADS_SCRIPT = `// Google Ads自动跟踪模板脚本
...
function GoogleAdsScriptPanel() {
  ...
  const scriptTemplates = [
    { id: 'normal', title: 'Normal Ads Template', content: GOOGLE_ADS_SCRIPT },
    { id: 'matrix', title: 'Matrix Ads Template', content: GOOGLE_ADS_SCRIPT },
  ]
